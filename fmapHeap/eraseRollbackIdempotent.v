...
Proof.
  ...
  {inv H. }
  {simpl in *. destruct a. destruct (beq_nat x i) eqn:eq. 
   {inv H0; auto. apply beq_nat_true in eq. subst. destruct (commit sc) eqn:eq2; auto. 
    destruct A; simpl; auto. rewrite eq2. auto. rewrite eq2; auto. simpl. rewrite eq2. auto. }
...
Proof.
  ...
  {eapply IHrollback. inversion H6. unfold tAdd. unfold Add. rewrite eraseUnionComm. 
   ...
   } rewrite H4. rewrite <- eraseUnionComm. constructor. eapply eraseHeapDependentRead. 
   eauto.
  }
