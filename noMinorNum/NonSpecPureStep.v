...
Theorem openErase : forall e1 e1' e2 e2' n, eraseTerm e1 e1' -> eraseTerm e2 e2' ->
                                              eraseTerm (open n e1 e2) (popen n e1' e2').
Proof.
  intros. genDeps{e1; e1'; n}. induction H0; intros; try solve[simpl;  auto].  
  {simpl. destruct (beq_nat n i) eqn:eq; auto. }
  {simpl. Admitted. 
...
Theorem eraseWF : forall E e E' e', eraseContext E E' -> eraseTerm e e' ->
...
Proof.
  ...
  inversion H1; constructor; subst. eapply IHeraseContext; eauto. 
...
Theorem NonSpecPureStep : forall h sh pt pt' tid s1 s2 M M' T T',
                            step h T (tSingleton (tid,s1,s2,M)) (OK h T (tSingleton(tid,s1,s2,M'))) ->
                            eraseTerm M pt -> eraseTerm M' pt' ->
...
Proof.
  ...
  {admit. }
  {copy H1. apply decomposeErase in H1. invertHyp. copy H8. apply decomposeEq in H8. subst. 
   apply decomposeErase in H0. invertHyp. inversion H0; subst. inversion H9; subst.
   eapply termErasureDeterminism in H1. rewrite <- H1. eapply pProjectL. 
   eapply ctxtErasureDeterminism in H7. rewrite <- H7. apply pdecomposeDecomposed.
   eapply eraseCtxtWF; eauto. constructor. constructor. apply decomposeWF in H6. auto. 
   constructor. constructor. auto. auto. }
  {copy H1. apply decomposeErase in H1. invertHyp. copy H8. apply decomposeEq in H8. subst. 
   apply decomposeErase in H0. invertHyp. inversion H0; subst. inversion H9; subst.
   eapply termErasureDeterminism in H1. rewrite <- H1. eapply pProjectR. 
   eapply ctxtErasureDeterminism in H7. rewrite <- H7. apply pdecomposeDecomposed.
   eapply eraseCtxtWF; eauto. constructor. constructor. apply decomposeWF in H6. auto. 
   constructor. constructor. auto. auto. }
  {subst. cleanup. copy H1. apply decomposeErase in H1. invertHyp. inversion H1; subst. 
   copy H8. apply decomposeEq in H8. subst. eapply decomposeErase in H0. invertHyp. inversion H0. 
   subst. inversion H12; subst. apply PBind. eapply termErasureDeterminism in H11; eauto. subst. 
   eapply termErasureDeterminism in H10; eauto. subst. eapply ctxtErasureDeterminism in H5; eauto.
   subst. apply pdecomposeDecomposed. eapply eraseCtxtWF; eauto. constructor. constructor. 
   apply decomposeWF in Hsubst. invertHyp. apply pdecomposeDecomposed. auto. }
