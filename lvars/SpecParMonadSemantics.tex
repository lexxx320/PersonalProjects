...
%\inference[\text{SpecRB}]{ws = \{\writes{S_1'} \; | \; \Theta_k''[S_1'', S_2'', M''] \in T \land \Theta_j' \sqsubseteq \Theta_k''\}, \;\;\; rollback(ws, [], v\vec{i}.T) \leadsto v\vec{i}.T'}{v\vec{i}.(T \; | \; \Theta_i[S_1, S_2, \mathcal{E}[specReturn(raise \; M, wait \; \Theta_j')]] \; | \; \Theta_j'[S_1', S_2', M']) \rightarrow v\vec{i}.(T' \; | \;  \Theta_{i+1}[S_1, S_2, \mathcal{E}[raise \; M]])}
