...
|unerase_thread : forall M M' t s2, uneraseTerm M' M -> 
...
Proof.
  ...
  {inversion H0; subst. econstructor. econstructor. constructor. assumption. }
Qed. 
...
Proof.
  induction t; intros; try solve[exists (Tid(0,0)nil); exists nil; constructor; assumption]. 
Qed. 
...
Proof.
  intros. inversion H; inversion H0; subst. inversion H6; subst. 
...
Theorem parDivergeSpecDiverge : forall H T H' T',
                                  ParDiverge H T -> eraseHeap H' H -> unerasePool T = T' ->
                                  SpecDiverge H' T'. 
Proof. 
  cofix. intros. inversion H0; subst. inversion H5; subst. 
  {erewrite unerasePoolUnion; eauto. 

instantiateTrm. inversion H2; subst.  
