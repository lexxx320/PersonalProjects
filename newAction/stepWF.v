...
Ltac eUnspec :=
  match goal with
    | |-multistep ?H ?T ?t (OK ?H' ?T' (tUnion  ?T'' (tSingleton ?t'))) =>
...
Proof.
  ...
  {destruct s1. 
   ...
   {inversion H0; subst. inversion H2; subst. econstructor; eauto. 
    ...
    erewrite unspecSingleton in H4; eauto. eapply multi_trans. eassumption. econstructor. 
    eauto. rewriteEmpty HNil. eassumption. constructor. eapply unspecSpecSame; eauto. }
  }
  {destruct s1. 
   {inversion H0; subst. inversion H2; subst. econstructor; eauto. 
    rewrite unspecUnionComm in *. erewrite unspecSingleton; eauto. 
  ...
  {destruct s1. 
   {inversion H0; subst. inversion H2; subst. econstructor; eauto. 
    ...
    unfold tUnion. rewrite union_empty_r. eapply multi_trans. copy d. apply decomposeEq in H. subst. 
    erewrite unspecSingleton in H4; eauto. copy d. apply decomposeEq in H. rewrite <- H.  
    econstructor. auto. unfold tUnion. rewrite union_empty_r. eassumption. unfold tCouple. 
