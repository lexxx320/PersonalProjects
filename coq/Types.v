...
Proof.
  ...
  unfold stuck. 
  split. 
  {unfold normal_form. unfold not. intros. inversion H. inversion H0. 
   inversion H2. }
...
Proof.
  induction t; unfold normal_form; unfold not. 
  {intros. inversion H0. inversion H1. }
  {intros. inversion H0. inversion H1. }
  {intros. inversion H. inversion H1. inversion H1. }
  {intros. inversion H0. inversion H1. }
  {intros. inversion H. 
   {inversion H1. }
   {inversion H1. assert(value t). right. assumption. apply IHt in H4. 
    inversion H0. inversion H5. unfold normal_form in H4. unfold not in H4. 
    apply H4. exists t1'. assumption. }
  }
...
Proof with eauto.
  ...
  {intros. inversion H0; subst. reflexivity. inversion H2; subst. 
   ...
   unfold normal_form in H1. unfold not in H1. apply ex_falso_quodlibet. 
   apply H1. exists t1'0. assumption. }
  {intros. inversion H0; subst. inversion H. assert(value y2). 
   right. assumption. apply value_is_nf in H1. unfold normal_form in H1. 
   unfold not in H1. apply ex_falso_quodlibet. apply H1. inversion H; subst. 
   exists t1'0. assumption. apply IHstep in H2; subst. reflexivity. }
  {intros. inversion H0; subst. reflexivity. inversion H1. }
  {intros. inversion H0; subst. reflexivity. assert(value t1). 
   right. assumption. apply value_is_nf in H1. unfold normal_form in H1. 
   unfold not in H1. apply ex_falso_quodlibet. apply H1. inversion H2; subst. 
   exists t1'0. assumption. }
  {intros. inversion H0; subst. inversion H. inversion H; subst. assert(value t0). 
   right. assumption. apply value_is_nf in H1. unfold normal_form in H1. 
   unfold not in H1. apply ex_falso_quodlibet. apply H1. exists t1'0. assumption. 
...
Proof with auto.
  ...
  Case "T_If".
    ...
    SCase "t1 can take a step".
      ...
      exists (tif t1' t2 t3)...
    SCase "t1 is tsucc t1'". 
      inversion IHHT. 
      {SSCase "t1' cannot step". inversion H. inversion H0; subst. 
       inversion HT. inversion HT. left. right. constructor. assumption. }
      {SSCase "t1' can step". inversion H. right. exists (tsucc x). 
       constructor. assumption. }
    SCase "t1 is tpred t1'".
      inversion IHHT.  
      {right. inversion H. inversion H0; subst. inversion HT. inversion HT. 
       inversion H0; subst. exists tzero. constructor. exists t. constructor. 
       inversion H0. assumption. }
      {right. inversion H. exists (tpred x). constructor. assumption. }
    SCase "t1 is tiszero t1". 
      inversion IHHT. 
      {right. inversion H. inversion H0; subst. inversion HT. inversion HT. 
       inversion H0. exists ttrue. constructor. exists tfalse. constructor. 
       assumption. }
      {right. inversion H. exists(tiszero x). constructor; assumption. }
Qed. 
...
Proof with auto.
  ...
  has_type_cases (induction HT) Case; 
    ...
    Case "T_Succ". inversion HE; subst. 
      {apply IHHT in H0. constructor. assumption. }
...
Theorem preservation' : forall t t' T,
  ...
  |- t' \in T.
Proof with eauto.
  intros. generalize dependent T. induction H0. 
  {intros. inversion H; subst. assumption. }
  {intros. inversion H; subst. assumption. }
  {intros. inversion H; subst. apply IHstep in H4. constructor; assumption. }
  {intros. inversion H; subst. apply IHstep in H2. constructor. assumption. }
  {intros. inversion H; subst. assumption. }
  {intros. inversion H0; subst. inversion H2; subst. assumption. }
  {intros. inversion H; subst. apply IHstep in H2. constructor. assumption. }
  {intros. inversion H. constructor. }
  {intros. inversion H0; subst. constructor. }
  {intros. inversion H; subst. inversion H. apply IHstep in H3. constructor. assumption. }
Qed.
...
Theorem SubjectExpansion : ~(forall t t' T, |- t' \in T -> t ==> t' -> |- t \in T). 
Proof. 
  unfold not; intros. 
  assert(|- ttrue \in TBool). constructor.
  assert(tif ttrue ttrue tzero ==> ttrue). constructor. 
  apply H with (t := tif ttrue ttrue tzero) in H0. inversion H0; subst. 
  inversion H8. assumption. Qed.
...
(** Suppose, that we add this new rule to the typing relation: 
   ...
   counterexample.
      ...
      - Progress               becomes false  - tsucc (false) is well typed, an
                               is not a value, but cannot take a step
...
determinism of step - tif ttrue t2 t3 ==> t2 and tif ttrue t2 t3 ==> t3
...
determinism of step - tif (tif true true true) (tif ttrue ttrue ttrue) tfalse can 
step on the condition or the true branch
