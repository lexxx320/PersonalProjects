...
controlChar | comment | escape | string | INITIAL
...
fun yyAction48 (strm, lastMatch : yymatch) = let
      ...
      in
        yystrm := strm;
        (YYBEGIN string; case Int.fromString(yytext) of
...
fun yyAction49 (strm, lastMatch : yymatch) = (yystrm := strm;
      (YYBEGIN controlChar; continue()))
fun yyAction50 (strm, lastMatch : yymatch) = let
      val yytext = yymktext(strm)
      in
        yystrm := strm;
        (YYBEGIN string; case Char.fromString("\\^" ^ yytext)
...
fun yyAction51 (strm, lastMatch : yymatch) = let
      ...
      in
        yystrm := strm;
        (YYBEGIN string; ErrorMsg.error yypos ("illegal escape sequence \\" ^ yytext); continue())
      end
fun yyAction52 (strm, lastMatch : yymatch) = let
      val yytext = yymktext(strm)
      in
        yystrm := strm; (yytext ^ lex())
      end
...
fun yyAction55 (strm, lastMatch : yymatch) = (yystrm := strm;
      (doneWithString := 1; YYBEGIN INITIAL; ""))
...
fun yyAction58 (strm, lastMatch : yymatch) = let
      ...
      in
        yystrm := strm;
        (Tokens.INT((revfold (fn(a,r)=>ord(a)-ord(#"0")+10*r) 
                                (explode yytext) 0), 
                       yypos, yypos+size(yytext)) )
      end
fun yyAction59 (strm, lastMatch : yymatch) = (yystrm := strm; (lex()))
fun yyAction60 (strm, lastMatch : yymatch) = (yystrm := strm; (lex()))
fun yyAction61 (strm, lastMatch : yymatch) = (yystrm := strm;
      (YYBEGIN comment; commentNesting := !commentNesting + 1 ; lex()))
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction57(strm, yyNO_MATCH)
                      else yyQ65(strm', yyMATCH(strm, yyAction57, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction57(strm, yyNO_MATCH)
                  else yyQ65(strm', yyMATCH(strm, yyAction57, yyNO_MATCH))
            else if inp = #"`"
              ...
              then if inp = #"_"
                  then yyQ65(strm', yyMATCH(strm, yyAction57, yyNO_MATCH))
       ...
       of NONE => yyAction57(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ69(strm', yyMATCH(strm, yyAction57, yyNO_MATCH))
            else if inp < #"e"
              then if inp = #"`"
                  then yyAction57(strm, yyNO_MATCH)
                  else yyQ65(strm', yyMATCH(strm, yyAction57, yyNO_MATCH))
       ...
       of NONE => yyAction57(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ68(strm', yyMATCH(strm, yyAction57, yyNO_MATCH))
            else if inp < #"l"
              then if inp = #"`"
                  then yyAction57(strm, yyNO_MATCH)
                  else yyQ65(strm', yyMATCH(strm, yyAction57, yyNO_MATCH))
       ...
       of NONE => yyAction57(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ67(strm', yyMATCH(strm, yyAction57, yyNO_MATCH))
            else if inp < #"i"
              then if inp = #"`"
                  then yyAction57(strm, yyNO_MATCH)
                  else yyQ65(strm', yyMATCH(strm, yyAction57, yyNO_MATCH))
       ...
       of NONE => yyAction57(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ66(strm', yyMATCH(strm, yyAction57, yyNO_MATCH))
            else if inp < #"h"
              then if inp = #"`"
                  then yyAction57(strm, yyNO_MATCH)
                  else yyQ65(strm', yyMATCH(strm, yyAction57, yyNO_MATCH))
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction3(strm, yyNO_MATCH)
                      else yyQ65(strm', yyMATCH(strm, yyAction3, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction3(strm, yyNO_MATCH)
                  else yyQ65(strm', yyMATCH(strm, yyAction3, yyNO_MATCH))
            else if inp = #"`"
              ...
              then if inp = #"_"
                  then yyQ65(strm', yyMATCH(strm, yyAction3, yyNO_MATCH))
       ...
       of NONE => yyAction57(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction57(strm, yyNO_MATCH)
                  else yyQ70(strm', yyMATCH(strm, yyAction57, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ65(strm', yyMATCH(strm, yyAction57, yyNO_MATCH))
              else yyAction57(strm, yyNO_MATCH)
      (* end case *))
       ...
       of NONE => yyAction57(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ76(strm', yyMATCH(strm, yyAction57, yyNO_MATCH))
            else if inp < #"e"
              then if inp = #"`"
                  then yyAction57(strm, yyNO_MATCH)
                  else yyQ65(strm', yyMATCH(strm, yyAction57, yyNO_MATCH))
       ...
       of NONE => yyAction57(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ75(strm', yyMATCH(strm, yyAction57, yyNO_MATCH))
            else if inp < #"p"
              then if inp = #"`"
                  then yyAction57(strm, yyNO_MATCH)
                  else yyQ65(strm', yyMATCH(strm, yyAction57, yyNO_MATCH))
       ...
       of NONE => yyAction57(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ78(strm', yyMATCH(strm, yyAction57, yyNO_MATCH))
            else if inp < #"n"
              then if inp = #"`"
                  then yyAction57(strm, yyNO_MATCH)
                  else yyQ65(strm', yyMATCH(strm, yyAction57, yyNO_MATCH))
       ...
       of NONE => yyAction57(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ77(strm', yyMATCH(strm, yyAction57, yyNO_MATCH))
            else if inp < #"e"
              then if inp = #"`"
                  then yyAction57(strm, yyNO_MATCH)
                  else yyQ65(strm', yyMATCH(strm, yyAction57, yyNO_MATCH))
        ...
        | SOME(inp, strm') =>
            if inp = #"a"
              ...
              then if inp = #"i"
                  ...
                  then yyQ73(strm', yyMATCH(strm, yyAction57, yyNO_MATCH))
                  else yyQ65(strm', yyMATCH(strm, yyAction57, yyNO_MATCH))
            else if inp = #"z"
              then yyQ65(strm', yyMATCH(strm, yyAction57, yyNO_MATCH))
            else if inp < #"z"
              then if inp = #"y"
                  then yyQ74(strm', yyMATCH(strm, yyAction57, yyNO_MATCH))
                  else yyQ65(strm', yyMATCH(strm, yyAction57, yyNO_MATCH))
              else yyAction57(strm, yyNO_MATCH)
      (* end case *))
       ...
       of NONE => yyAction57(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ79(strm', yyMATCH(strm, yyAction57, yyNO_MATCH))
            else if inp < #"f"
              then if inp = #"`"
                  then yyAction57(strm, yyNO_MATCH)
                  else yyQ65(strm', yyMATCH(strm, yyAction57, yyNO_MATCH))
       ...
       of NONE => yyAction57(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ81(strm', yyMATCH(strm, yyAction57, yyNO_MATCH))
            else if inp < #"l"
              then if inp = #"`"
                  then yyAction57(strm, yyNO_MATCH)
                  else yyQ65(strm', yyMATCH(strm, yyAction57, yyNO_MATCH))
       ...
       of NONE => yyAction57(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ80(strm', yyMATCH(strm, yyAction57, yyNO_MATCH))
            else if inp < #"i"
              then if inp = #"`"
                  then yyAction57(strm, yyNO_MATCH)
                  else yyQ65(strm', yyMATCH(strm, yyAction57, yyNO_MATCH))
       ...
       of NONE => yyAction57(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ83(strm', yyMATCH(strm, yyAction57, yyNO_MATCH))
            else if inp < #"t"
              then if inp = #"`"
                  then yyAction57(strm, yyNO_MATCH)
                  else yyQ65(strm', yyMATCH(strm, yyAction57, yyNO_MATCH))
       ...
       of NONE => yyAction57(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ82(strm', yyMATCH(strm, yyAction57, yyNO_MATCH))
            else if inp < #"e"
              then if inp = #"`"
                  then yyAction57(strm, yyNO_MATCH)
                  else yyQ65(strm', yyMATCH(strm, yyAction57, yyNO_MATCH))
       ...
       of NONE => yyAction57(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"`"
              ...
              then if inp = #"f"
                  then yyQ84(strm', yyMATCH(strm, yyAction57, yyNO_MATCH))
                  else yyQ65(strm', yyMATCH(strm, yyAction57, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ65(strm', yyMATCH(strm, yyAction57, yyNO_MATCH))
              else yyAction57(strm, yyNO_MATCH)
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction4(strm, yyNO_MATCH)
                      else yyQ65(strm', yyMATCH(strm, yyAction4, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction4(strm, yyNO_MATCH)
                  else yyQ65(strm', yyMATCH(strm, yyAction4, yyNO_MATCH))
            else if inp = #"`"
       ...
       of NONE => yyAction57(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ93(strm', yyMATCH(strm, yyAction57, yyNO_MATCH))
            else if inp < #"n"
              then if inp = #"`"
                  then yyAction57(strm, yyNO_MATCH)
                  else yyQ65(strm', yyMATCH(strm, yyAction57, yyNO_MATCH))
       ...
       of NONE => yyAction57(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ92(strm', yyMATCH(strm, yyAction57, yyNO_MATCH))
            else if inp < #"o"
              then if inp = #"`"
                  then yyAction57(strm, yyNO_MATCH)
                  else yyQ65(strm', yyMATCH(strm, yyAction57, yyNO_MATCH))
       ...
       of NONE => yyAction57(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ94(strm', yyMATCH(strm, yyAction57, yyNO_MATCH))
            else if inp < #"r"
              then if inp = #"`"
                  then yyAction57(strm, yyNO_MATCH)
                  else yyQ65(strm', yyMATCH(strm, yyAction57, yyNO_MATCH))
       ...
       of NONE => yyAction57(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ99(strm', yyMATCH(strm, yyAction57, yyNO_MATCH))
            else if inp < #"e"
              then if inp = #"`"
                  then yyAction57(strm, yyNO_MATCH)
                  else yyQ65(strm', yyMATCH(strm, yyAction57, yyNO_MATCH))
       ...
       of NONE => yyAction57(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"`"
              ...
              then yyQ96(strm', yyMATCH(strm, yyAction57, yyNO_MATCH))
            else if inp < #"n"
              then if inp = #"l"
                  then yyQ95(strm', yyMATCH(strm, yyAction57, yyNO_MATCH))
                  else yyQ65(strm', yyMATCH(strm, yyAction57, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ65(strm', yyMATCH(strm, yyAction57, yyNO_MATCH))
              else yyAction57(strm, yyNO_MATCH)
       ...
       of NONE => yyAction57(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ100(strm', yyMATCH(strm, yyAction57, yyNO_MATCH))
            else if inp < #"o"
              then if inp = #"`"
                  then yyAction57(strm, yyNO_MATCH)
                  else yyQ65(strm', yyMATCH(strm, yyAction57, yyNO_MATCH))
       ...
       of NONE => yyAction57(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction57(strm, yyNO_MATCH)
                  else yyQ103(strm', yyMATCH(strm, yyAction57, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ65(strm', yyMATCH(strm, yyAction57, yyNO_MATCH))
              else yyAction57(strm, yyNO_MATCH)
      (* end case *))
       ...
       of NONE => yyAction57(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ101(strm', yyMATCH(strm, yyAction57, yyNO_MATCH))
            else if inp < #"r"
              then if inp = #"`"
                  then yyAction57(strm, yyNO_MATCH)
                  else yyQ65(strm', yyMATCH(strm, yyAction57, yyNO_MATCH))
       ...
       of NONE => yyAction57(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ108(strm', yyMATCH(strm, yyAction57, yyNO_MATCH))
            else if inp < #"y"
              then if inp = #"`"
                  then yyAction57(strm, yyNO_MATCH)
                  else yyQ65(strm', yyMATCH(strm, yyAction57, yyNO_MATCH))
       ...
       of NONE => yyAction57(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction57(strm, yyNO_MATCH)
                  else yyQ107(strm', yyMATCH(strm, yyAction57, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ65(strm', yyMATCH(strm, yyAction57, yyNO_MATCH))
              else yyAction57(strm, yyNO_MATCH)
      (* end case *))
...
fun yyQ46 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction23(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"="
              then yyQ109(strm', yyMATCH(strm, yyAction23, yyNO_MATCH))
...
fun yyQ42 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction40(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"="
              then yyQ112(strm', yyMATCH(strm, yyAction40, yyNO_MATCH))
...
fun yyQ113 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction58(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"0"
              then yyQ113(strm', yyMATCH(strm, yyAction58, yyNO_MATCH))
            else if inp < #"0"
       ...
       of NONE => yyAction59(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"\n"
              ...
              else yyQ115(strm', yyMATCH(strm, yyAction59, yyNO_MATCH))
      (* end case *))
       ...
       of NONE => yyAction60(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"\n"
              ...
              then if inp = #"\t"
                  then yyQ116(strm', yyMATCH(strm, yyAction60, yyNO_MATCH))
       ...
       of NONE => yyAction43(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"\v"
              ...
              then if inp <= #"\b"
                  then yyAction43(strm, yyNO_MATCH)
                  else yyQ25(strm', yyMATCH(strm, yyAction43, yyNO_MATCH))
            else if inp = #" "
              then yyQ25(strm', yyMATCH(strm, yyAction43, yyNO_MATCH))
       ...
       of NONE => yyAction52(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"\""
              ...
              then if inp = #"\n"
                  then yyAction52(strm, yyNO_MATCH)
                  else yyQ27(strm', yyMATCH(strm, yyAction52, yyNO_MATCH))
            else if inp = #"\\"
              then yyAction52(strm, yyNO_MATCH)
              else yyQ27(strm', yyMATCH(strm, yyAction52, yyNO_MATCH))
      (* end case *))
...
fun yyQ14 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction51(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"0"
              then yyQ19(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
            else if inp < #"0"
...
in
  (case (!(yyss))
   of controlChar => yyQ0(!(yystrm), yyNO_MATCH)
